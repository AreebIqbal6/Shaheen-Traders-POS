...
export const exportReportToExcel = async (data: ReportData) => {
  ...
  // Grid
  sheet.getCell('A7').value = 'REPORT TYPE:'; sheet.getCell('A7').font = { bold: true };
  sheet.getCell('B7').value = data.title;
  sheet.getCell('E7').value = 'GENERATED ON:'; sheet.getCell('E7').font = { bold: true };
  sheet.getCell('F7').value = new Date(data.createdAt).toLocaleDateString();

  sheet.getCell('A8').value = 'PERIOD:'; sheet.getCell('A8').font = { bold: true };
  sheet.getCell('B8').value = data.reportPeriod;
  sheet.getCell('E8').value = 'REPORT ID:'; sheet.getCell('E8').font = { bold: true };
  sheet.getCell('F8').value = data.id;
