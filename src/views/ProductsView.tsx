  ...
  return (
    <div className="h-full flex flex-col relative bg-slate-50 dark:bg-[#0a0a0c] p-4 md:p-8 overflow-x-hidden">
      ...
      <div className="mb-4 flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4">
        <div className="flex bg-white dark:bg-zinc-900/60 backdrop-blur-md p-1 rounded-lg border border-slate-200 dark:border-zinc-800/50 w-full md:w-auto shadow-inner gap-1 overflow-x-auto hide-horizontal-scrollbar">
          <button 
